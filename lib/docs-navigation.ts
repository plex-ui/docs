...
type SidebarEntry = { label: string; url: string };

const GET_STARTED: SidebarEntry[] = [
  { label: 'Introduction', url: '/docs' },
  { label: 'Installation', url: '/docs/installation' },
  { label: 'Changelog', url: '/docs/changelog' },
];

const FOUNDATIONS: SidebarEntry[] = [
...
const AI_DISTRIBUTION: SidebarEntry[] = [
...
function processRoot(root: PageTree.Root) {
  ...
  nextChildren.push({ type: 'separator', name: 'Get Started' });
  nextChildren.push(...toSidebarItems(GET_STARTED));

  nextChildren.push({ type: 'separator', name: 'Foundations' });
  nextChildren.push(...toSidebarItems(FOUNDATIONS));

  nextChildren.push({ type: 'separator', name: 'AI & Distribution' });
  nextChildren.push(...toSidebarItems(AI_DISTRIBUTION));

  nextChildren.push({ type: 'separator', name: 'API' });
  nextChildren.push(...toSidebarItems(API));
