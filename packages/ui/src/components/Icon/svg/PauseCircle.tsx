...
const PauseCircle = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
    ...
    />
    <path
      d="M9.5 8.75C9.08578 8.75 8.75 9.08578 8.75 9.5V14.5C8.75 14.9142 9.08578 15.25 9.5 15.25H10.5C10.9142 15.25 11.25 14.9142 11.25 14.5V9.5C11.25 9.08578 10.9142 8.75 10.5 8.75H9.5Z"
      fill="currentColor"
    />
    <path
      fillRule="evenodd"
