...
const ExclamationMarkCircle = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
    ...
    />
    <path
      d="M12.0001 14.7C11.365 14.7 10.8501 15.2148 10.8501 15.85C10.8501 16.4851 11.365 17 12.0001 17C12.6352 17 13.1501 16.4851 13.1501 15.85C13.1501 15.2148 12.6352 14.7 12.0001 14.7Z"
      fill="currentColor"
    />
  </svg>
)
