...
A production-grade design system based on the same foundations as [OpenAI's Apps SDK UI](https://github.com/openai/apps-sdk-ui), the component library used inside **ChatGPT**. Tailwind 4 styling, CSS variable design tokens, accessible components, and pixel-perfect Figma parity.

### Why Plex UI

**Battle-tested at ChatGPT scale.** These components come from the design system behind a product used by hundreds of millions of people. Not theoretical, not designed in a vacuum.
