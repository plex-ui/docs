...
<ComponentPreview code={`<Accordion type="single" collapsible defaultValue="whats-new">
  <Accordion.Item value="whats-new">
    <Accordion.Trigger>What shipped in 0.12?</Accordion.Trigger>
    <Accordion.Content>Accordion, Chart, and Command primitives landed…</Accordion.Content>
  </Accordion.Item>
  <Accordion.Item value="migrate">
    <Accordion.Trigger>How do I upgrade from 0.11?</Accordion.Trigger>
    <Accordion.Content>Bump @plexui/ui and rerun the codemod…</Accordion.Content>
  </Accordion.Item>
  <Accordion.Item value="support">
    <Accordion.Trigger>Where can I report issues?</Accordion.Trigger>
    <Accordion.Content>File them on GitHub or ping us in Discord…</Accordion.Content>
  </Accordion.Item>
</Accordion>`}>
  <AccordionOverviewDemo />
</ComponentPreview>
