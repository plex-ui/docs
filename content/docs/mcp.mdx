---
title: MCP Server
description: Plex UI MCP server gives AI editors like Claude Code, Cursor, VS Code Copilot, OpenCode, and Codex full access to component docs, props, and examples
---
