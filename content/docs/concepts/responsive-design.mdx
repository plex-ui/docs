...
description: Build adaptive React interfaces with Plex UI — default Tailwind breakpoints, responsive props, and the useBreakpoint hook for runtime checks
---
...
## Default breakpoints
Default breakpoints are provided out-of-the-box with Plex UI, and are integrated into Tailwind and React utilities.
...
| `sm` | `576px` | Landscape mobile, phablet | Collapsed mobile menu, Single-column list/detail views |
| `md` | `768px` | Tablet | Expanded primary navigation, Fixed left sidebar navigation |
| `lg` | `1024px` | Laptop | Tight column layouts, Sticky sidebar in API Ref |
