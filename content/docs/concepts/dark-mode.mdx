---
title: Dark mode
description: Configure light and dark mode in your React app with Plex UI — Tailwind setup, persistent theme storage, and the useDocumentTheme hook
---
...
```tsx
import { getDocumentTheme } from "@plexui/ui/theme"
...
```tsx
import { useDocumentTheme } from "@plexui/ui/theme"
