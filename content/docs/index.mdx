...
For full setup (including optional router integration and provider), see [Installation](/docs/installation).

## Get started

<Cards>
  <Card title="Installation" description="Start using Plex UI in your app" href="/docs/installation" />
