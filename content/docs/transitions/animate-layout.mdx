...
description: AnimateLayout React primitive for smoothly animating width and height changes — accordion expansion, growing buttons, and dynamic content panels
---
