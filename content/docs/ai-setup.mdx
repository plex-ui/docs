...
Download a comprehensive reference file that gives your AI editor complete knowledge of all 47 components, 14 hooks, design tokens, and usage patterns.
...
- **47 components** — import paths, props, types, defaults, sub-components
- **653 icons** — import examples and naming conventions
...
- Icons: `import { IconName } from "@plexui/ui/components/Icon"` — 653 icons available
