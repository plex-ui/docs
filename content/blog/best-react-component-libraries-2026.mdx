...
[Plex UI](/components) ships {COMPONENTS_COUNT} accessible React components built on Radix primitives and Tailwind CSS 4. The differentiator is a three-layer design token system — primitive, semantic, and component-level — that maps one-to-one between React and a commercial Figma kit with 22,000+ variants.
...
The [AI Bridge](/bridge) exposes Figma read/write access to any model that supports tool use — Claude, Cursor, Codex — so generated code and design stay synchronized.
...
| Library | Components | Styling | Design tokens | Figma kit | Dark mode | Bundle size |
|---|---|---|---|---|---|---|
| Plex UI | {COMPONENTS_COUNT} | Tailwind CSS 4 | Three-layer system | Paid (22k variants) | CSS light-dark() | Small |
...
**You need design-code parity with AI workflows.** Plex UI's token system and [AI Bridge](/bridge) are built for this. No other library offers bidirectional Figma synchronization through AI tool use.
