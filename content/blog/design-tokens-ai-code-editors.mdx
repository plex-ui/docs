...
Your design system has a `Button` component with nine sizes and six color variants. Every size carries correct padding, font size, icon size, and radius. The AI-generated version captures one snapshot of one variant and hardcodes everything.
