...
The important part is not only the number of steps. It is that the same scale applies across [primary controls](/components): Button, Input, Select, SelectControl, and SegmentedControl.
