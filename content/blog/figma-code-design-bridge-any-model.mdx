...
[Standard Figma MCPs](/blog/figma-mcp-vs-ai-bridge) — including the official read-only one — return raw values from your designs.
...
Now the AI writes `var(--color-background-primary-solid)` instead of `#181818`. Your [design tokens](/blog/design-tokens-ai-code-editors) handle light/dark mode, density scales, and theme changes automatically.
...
- [Claude](/blog/connect-claude-code-to-figma), GPT, [Cursor](/blog/connect-cursor-to-figma), Codex, Gemini, Copilot, Windsurf, and others.
