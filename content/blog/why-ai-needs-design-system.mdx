...
Plex UI exists to make that contract explicit: shared [components](/components), a full control-size scale, and token architecture that maps cleanly from Figma to React with [AI Bridge](/bridge).
